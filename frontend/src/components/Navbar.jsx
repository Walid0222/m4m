          ...
          <div className="hidden md:flex items-center gap-2">
            {user && (
              <>
                ...
                <Link
  to="/wallet"
  className="flex items-center justify-end gap-1.5 px-3 py-2 rounded-xl text-sm font-semibold text-m4m-purple min-w-[170px] shrink-0"
>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                  </svg>
                  <span
  className={`inline-block w-[110px] text-right transition-all duration-200 ease-out ${
              ...
              {user ? (
                <>
                  ...
                  {[
                    ...
                    { to: '/affiliate/dashboard', label: t('nav.affiliate_dashboard') },
